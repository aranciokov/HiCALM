...
class VSFormer(nn.Module):
    ...
    def __init__(self, feature_dim, num_layers, num_heads, attention_dropout, mlp_dropout, widening_factor, output_feature_size, art_features_size=0):
        ...
        self.encoder = TransformerEncoder(num_layers, num_heads, v_feature_dim, v_feature_dim, v_feature_dim, attention_dropout, mlp_dropout, widening_factor)
